...
export default function WhatsApp_Button(){
    return(
        <a 
            ...
            target="_blank"
            rel="noreferrer"
            className="flex flex-row items-center bg-gradient-to-r from-[#141e30] to-[#243b55] rounded-full p-4 w-full lg:w-[50%] justify-center shadow-xl lg:hover:scale-105 transition-all"
        >
